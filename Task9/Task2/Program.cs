...
namespace Task1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var array = new DynamicArray<TestObject>();
            ...
            var arr = new TestObject[3] { testObject, testObject1, testObject2 };
            array.AddRange(arr);
            ShowDynamicArray(array);
            Console.ReadLine();
        }

        static void ShowDynamicArray(DynamicArray<TestObject> array)
        {
